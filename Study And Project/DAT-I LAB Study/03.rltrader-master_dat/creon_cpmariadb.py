...
class CpDB:
    def __init__(self):
        ...
        self.con = pymysql.connect(host='localhost', port=3316, user='root', passwd='datdb123!!', db='MySql', charset='utf8', autocommit=False)
        # Connection 으로부터 Dictoionary Cursor 생성
        self.cur = self.con.cursor(pymysql.cursors.DictCursor)

    def connect(self):
        con = pymysql.connect(host='localhost', port=3316, user='root', passwd='datdb123!!', db='MySql', charset='utf8', autocommit=False)
        return con
    
    def stkhistprc(self, con, tp, idata):
        ...
        if  tp == 'S':
            ...
            odata = pd.read_sql_query(sql, con, params=(idata.item, idata.from_ymd, idata.to_ymd,))
            print(odata)
