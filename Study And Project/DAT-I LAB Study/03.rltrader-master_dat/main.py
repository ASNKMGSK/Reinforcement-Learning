...
python main.py --stock_code=A005930 --ver=v1 --rl_method=dqn --num_epoches=1 --value_network_name=dqn_dnn_value --start_date=20200101 --end_date=20200915
"""
...
if __name__ == '__main__':
    ...
    parser.add_argument('--start_date', default='20200805')
    parser.add_argument('--end_date', default='20200805')
    ...
    if args.value_network_name is not None:
        ...
        logging.info("EXIST value_network_path[{}]".format(value_network_path))
    ...
    if args.policy_network_name is not None:
        ...
        logging.info("EXIST policy_network_path[{}]".format(policy_network_path))
    ...
    for stock_code in args.stock_code:
        ...
        # 주식 원 천차트 데이터, 학,습 데이터 준비
        chart_data, training_data, stock_data = data_manager.load_data(
